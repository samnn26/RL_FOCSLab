...
from optical_rl_gym.heuristics import kSP_FF, FF_kSP, kSP_MU, CA_MU, kSP_FF_binary, FF_kSP_binary, kSP_MU_binary
...
# with open(current_directory+'/topologies/dtag_5-paths.h5', 'rb') as f:
#     topology_5 = pickle.load(f)
# with open(current_directory+'/topologies/dtag_4-paths.h5', 'rb') as f:
#     topology_4 = pickle.load(f)
# with open(current_directory+'/topologies/dtag_3-paths.h5', 'rb') as f:
#     topology_3 = pickle.load(f)
# with open(current_directory+'/topologies/dtag_2-paths.h5', 'rb') as f:
#     topology_2 = pickle.load(f)
# with open(current_directory+'/topologies/dtag_1-paths.h5', 'rb') as f:
#     topology_1 = pickle.load(f)
...
env_5 = gym.make('RWAFOCS-v222', **env_args_5)
print('RWAFOCS-v222')

# heuristic = kSP_FF_binary
# heuristic = FF_kSP_binary
heuristic = kSP_MU_binary
...
mean_reward_5, std_reward_5 = evaluate_heuristic(env_5, heuristic, n_eval_episodes=10,
                       render=False, callback=None, reward_threshold=None,
                       return_episode_rewards=False)
