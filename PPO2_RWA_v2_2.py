...
agent = PPO2(MlpPolicy, env, verbose=0, tensorboard_log="./tb/PPO-RWA-v22/", policy_kwargs=policy_args, gamma=.95, learning_rate=10e-5)

a = agent.learn(total_timesteps=200000, callback=callback)
results_plotter.plot_results([log_dir], 1e5, results_plotter.X_TIMESTEPS, "RWA_V2_2")
