...
from stable_baselines_extension.feature_extraction import gnn_extractor, gnn_iter_extractor
from stable_baselines.common.distributions import make_proba_dist_type, CategoricalProbabilityDistribution, \
    MultiCategoricalProbabilityDistribution, DiagGaussianProbabilityDistribution, BernoulliProbabilityDistribution



class FeedForwardGnnPolicy(ActorCriticPolicy):
    """
    ...
    :param feature_extraction: (str) The feature extraction type ("gnn",  "cnn" or "mlp")
    ...
    def __init__(self, sess, ob_space, ac_space, n_env, n_steps, n_batch,
                 ...
                 **kwargs):
        super(FeedForwardGnnPolicy, self).__init__(sess, ob_space, ac_space,
...
class GnnPolicy(FeedForwardGnnPolicy):



    def __init__(self, *args, **kwargs):
        super(GnnPolicy, self).__init__(*args, **kwargs,
