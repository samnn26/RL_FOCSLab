...
def main():
    ...
    if len(continuedexp)>0:
        ...
        if number_of_cores == 1:
            ...
            if gpu:
                agent = PPO('MultiInputPolicy', env, verbose=0, policy_kwargs=policy_args, gamma=gamma, learning_rate=learningrate, batch_size = batchsize, device='cuda')
            else:
                agent = PPO('MultiInputPolicy', env, verbose=0, policy_kwargs=policy_args, gamma=gamma, learning_rate=learningrate, batch_size = batchsize)
