...
env_0 = gym.make(env_id, **env_args)
...
pickle.dump(end_rl-start_rl, open("eval_timing/"+exp_id+"_RL.pkl", 'wb'))
pickle.dump(end_rand-start_rand, open("eval_timing/"+exp_id+"_rand.pkl", 'wb'))
